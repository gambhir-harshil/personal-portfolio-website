    ...
    >
      ...
      >
        <p className="text-base xl:text-lg text-secondary md:mt-20 md:ml-10">
          ...
          set of skills that make me an invaluable asset to any project. I have
          a deep understanding of of{" "}
          <span className="text-white">JavaScript</span>,{" "}
          <span className="text-white">HTML</span> and{" "}
          <span className="text-white">CSS</span> and I am able to use these
          languages to create dynamic and interactive user interfaces. Above,
          all I have a passion for using my skills to build innovative,
          cutting-edge web applications that make a difference in people's
          lives.
        </p>
      </motion.div>
    </div>
