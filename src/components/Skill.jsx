...
import { html, javascript, mongodb, nodejs, react, tailwind, typescript } from '../assets'

const Skill = ({skill}) => {
  return (
    <div className='relative flex flex-col items-center justify-center cursor-pointer text-center'>
